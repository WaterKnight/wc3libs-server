...
import net.moonlightflower.wc3server.service.W3AService;
...
public class W3AController {
    private final W3AService w3AService;
    ...
    public ResponseEntity<String> convert(HttpServletRequest request) throws IOException {
        return ResponseEntity.ok(w3AService.convertToJson(request.getInputStream().readAllBytes()));
    }
}
